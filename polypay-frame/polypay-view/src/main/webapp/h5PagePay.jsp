...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<form role="form" action="h5pay.do" method="post"  name="payForm" target="_blank">
				<input type="hidden" name="url" id="url" value="<%=Config.getInstance().getPayCashierUrl()%>"/>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="version" id="version" value="<%=Config.getInstance().getVersion4Cashier()%>" readonly>
				</div>
				<div class="form-group">
