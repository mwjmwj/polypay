...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<form role="form" action="h5pay.do" method="post"  name="payForm" >
				<input type="hidden" name="url" id="url" value="<%=Config.getInstance().getPayH5ReqUrl()%>"/>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="version" id="version" value="<%=Config.getInstance().getVersion4Unionpay()%>" readonly>
				</div>
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" name="amount" value="20" required>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="goodsName" value="移动银联H5测试" required>
				</div>
					
				<div class="form-group">
					<label for="goodsInfo">商品信息</label>
					<input type="text" class="form-control" name="goodsInfo" value="移动银联H5测试">
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="buyerName" value="张杨" required>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="referer" value="<%=Config.getInstance().getPayH5ReqUrl() %>">
				</div>
