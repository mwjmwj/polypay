 ...
 *  瑞鑫支付
 */
public class HPayChannel implements IPayChannel{
    ...
    public static final String METCHANT_NO = "MD202003090000000661";
    public static final String KEY = "7VJoOCTThe21yC8c6FgoaSEH79cm7Bje";
...
//        }
        ...
        String PAY_URL = "https://pay.xxiamenchangmateng.xyz/paygateway/gateway/api/pay";
...
//        if (nowMac.equals(mac)) { //若mac校验匹配
    ...
    public Map<String, Object> settleOrder(MerchantSettleOrder selectByPrimaryKey) throws Exception {
        ...
        try {
            ...
            String pwdString = PayPWD+"EJUkpRBGyEatCUtUU5epX9DF1T0Iufc7";
